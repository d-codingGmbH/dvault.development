  ...
  public static int Run(string[] args, TextWriter output, TextWriter error) {
    ...
    if (result.Succeeded) {
      output.WriteLine(
          ...
          "': exactly fourteen .nupkg files, twelve .snupkg files, metadata, dual-line README guidance, XML docs, symbols, analyzer assets, provider dependencies, and line-specific net8.0/net10.0 EF dependency groups are valid.");
      return 0;
    }
