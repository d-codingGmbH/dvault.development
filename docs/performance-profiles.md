...
## v0.40.0 Provider Bulk And Read Evidence Boundary

The v0.40.0 provider-bulk and provider-read documentation baseline separates measured facts from strategy availability, skipped guidance rows, diagnostics-only posture, and forward-looking recommendations:
