...
Status: v0.50.0 package, analyzer, privacy adoption, and migration-validation baseline with carried-forward v0.49.0 modeling/generator parity, v0.47.0 provider maintenance documentation, and v0.46.0 provider optimization closure evidence

This guide is the detailed performance-profile reference for the current DVault performance-guidance baseline. It carries forward the v0.31.0 adopter decision tree, the v0.32.0 provider-threshold evidence bundles, the checked-in DB2 hotspot evidence bundle, the review-only provider-specific SQL artifact gate, the v0.42.0 provider evidence promotion rules and tuning gates, the current provider-read parity evidence posture, the v0.43.0 provider binary-vs-hex hash-key matrix, the v0.43.0 allocation-hotspot evidence, the source/test-backed PIT maintenance boundary for PostgreSQL, SQL Server, and MySQL, and the 2026-06-23 provider optimization closure bundle. It does not create automatic routing, absolute performance guarantees, provider service-level objectives, dashboards, hosted observability, database provisioning, scheduler templates, credential-management guidance, automatic hash-key migration, automatic PIT or bridge maintenance, raw SQL or physical-plan promises, deployable provider-specific SQL payload generation, runtime artifact dispatch, package-publication approval, provider-specific bridge maintenance, dependent child key modeling, or provider support outside the evidence-linked rows. The coordinated release record for the current package, analyzer, privacy adoption, hash-key storage migration manifest validation, and adoption baseline is [DVault v0.50.0 Release Notes](releases/v0.50.0.md). The coordinated release record for the modeling/generator parity baseline is [DVault v0.49.0 Release Notes](releases/v0.49.0.md). The coordinated release record for the provider-maintenance documentation boundary is [DVault v0.47.0 Release Notes](releases/v0.47.0.md). The coordinated release record for the provider optimization closure evidence is [DVault v0.46.0 Release Notes](releases/v0.46.0.md). The coordinated release record for the initial PIT maintenance exploration baseline is [DVault v0.45.0 Release Notes](releases/v0.45.0.md). The coordinated release record for the binary-adoption, allocation, provider-bulk, provider-read parity, evidence, and tuning baseline is [DVault v0.43.0 Release Notes](releases/v0.43.0.md). The optional privacy extension foundation remains documented in [DVault v0.44.0 Release Notes](releases/v0.44.0.md). Earlier release notes remain historical feature-introduction records.
