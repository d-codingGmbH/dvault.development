...
- nine `8.47.0` `.nupkg` files with `net8.0` assets and EF Core 8 dependency groups
- nine `10.47.0` `.nupkg` files with `net10.0` assets and EF Core 10 dependency groups
