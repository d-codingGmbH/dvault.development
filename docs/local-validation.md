...
- eight `8.38.0` `.nupkg` files with `net8.0` assets and EF Core 8 dependency groups
- eight `10.38.0` `.nupkg` files with `net10.0` assets and EF Core 10 dependency groups
