...
Provider schema guardrails are design-time review and diagnostics boundaries for DVault-owned generated metadata. They do not add provider-specific guarantees outside SQLite, Oracle, PostgreSQL, SQL Server, and MySQL; they do not silently map unrecognized providers to supported profiles; and they do not repair migrations, execute migrations, rewrite raw SQL, or rewrite arbitrary consumer-authored DDL.
