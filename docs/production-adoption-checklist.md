...
- Chunked explicit saves do not introduce provider-native chunk execution, staged provider bulk ingestion, background ingestion, file ingestion, CDC ingestion, schedulers, or implicit `SaveChanges` streaming.
