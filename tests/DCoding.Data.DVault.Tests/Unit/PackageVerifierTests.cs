...
public sealed class PackageVerifierTests {
  ...
  private const string Net8PackageLineVersion = "8.38.0";
  private const string Net10PackageLineVersion = "10.38.0";
  ...
  [Theory]
  [InlineData("dotnet add package DCoding.Data.DVault --version 0.38.0\n", "0.38.0")]
