...
public sealed class PackageVerifierTests {
  ...
  private const string Net8PackageLineVersion = "8.49.0";
  private const string Net10PackageLineVersion = "10.49.0";
  ...
  private const string ExpectedAnalyzerBuildHostGuidance = "Build projects that reference `DCoding.Data.DVault.Analyzers` with a `.NET 10 SDK` host, including `net8.0` projects using the `8.49.0` package line.";
  ...
  [Theory]
  [InlineData("dotnet add package DCoding.Data.DVault --version 0.39.0\n", "0.39.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 0.40.0\n", "0.40.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 0.41.0\n", "0.41.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 0.42.0\n", "0.42.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 0.43.0\n", "0.43.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 0.44.0\n", "0.44.0")]
  ...
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.39.0\n", "8.39.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 10.39.0\n", "10.39.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.40.0\n", "8.40.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 10.40.0\n", "10.40.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.41.0\n", "8.41.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 10.41.0\n", "10.41.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.42.0\n", "8.42.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 10.42.0\n", "10.42.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.43.0\n", "8.43.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 10.43.0\n", "10.43.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.44.0\n", "8.44.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 10.44.0\n", "10.44.0")]
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.45.0\n", "8.45.0")]
  ...
  [InlineData("dotnet add package DCoding.Data.DVault --version 8.48.0\n", "8.48.0")]
