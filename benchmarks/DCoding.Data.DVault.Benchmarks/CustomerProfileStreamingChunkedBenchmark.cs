...
internal sealed class CustomerProfileStreamingChunkedBenchmark : CustomerProfileStreamingSaveBenchmarkBase {
  public CustomerProfileStreamingChunkedBenchmark(int chunkSize)
      : this(chunkSize, BenchmarkHashKeyVariant.Default) {
  }

  public CustomerProfileStreamingChunkedBenchmark(
      int chunkSize,
