...
SQLite emits one row for each strategy family:

- `classic-ef`
- `provider-neutral-dvault-fallback`
- `sqlite-optimized-dvault`

When PostgreSQL, SQL Server, MySQL, or Oracle is configured and reachable, each Data Vault scenario also emits:
