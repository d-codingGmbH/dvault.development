...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSCH65R88BT6PS7XV32NQ1M-task-close-db2-pit-and-bridge-read-gaps"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsch65r88bt6ps7xv32nq1m:audit-only:writeback:tp6:wg-close:integrator:dda188335623a8d8 -->