...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FH8RFJYY09BJJK4MD2KT8BF0-story-add-optional-provider-native-crypto-capabi"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fh8rfjyy09bjjk4md2kt8bf0:audit-only:writeback:tp6:wg-close:integrator:5640fedaf201bd2e -->