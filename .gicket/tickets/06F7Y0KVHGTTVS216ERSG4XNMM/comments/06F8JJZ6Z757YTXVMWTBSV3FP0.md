...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F7Y0KVHGTTVS216ERSG4XNMM-story-add-provider-idempotency-constraint-and-in"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f7y0kvhgttvs216ersg4xnmm:audit-only:writeback:tp6:wg-close:integrator:a64ae51afae8c673 -->