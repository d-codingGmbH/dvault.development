...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F8KZNNS76TD9Z7ESB173FZ68-task-update-v0-29-0-provider-schema-guardrail-do"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f8kznns76td9z7esb173fz68:audit-only:writeback:tp6:wg-close:integrator:63d2fdbe21d05b88 -->