Add first-class live schema readers for PostgreSQL, SQL Server, Oracle, and MySQL so drift reports do not rely on SQLite-only evidence.

## Scope
- Refine and complete the work for "Add provider live schema drift readers" within the boundaries of its parent story, epic, and release.
