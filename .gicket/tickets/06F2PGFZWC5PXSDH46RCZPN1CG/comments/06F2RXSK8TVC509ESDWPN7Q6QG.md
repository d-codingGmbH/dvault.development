...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F2PGFZWC5PXSDH46RCZPN1CG-story-add-provider-live-schema-drift-readers"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f2pgfzwc5pxsdh46rczpn1cg:audit-only:writeback:tp6:wg-close:integrator:8ae134deae37ecc4 -->