...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FH8R9DPSKTNYB46HHVJMZ9P8-story-close-provider-optimization-parity-gaps-fr"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fh8r9dpsktnyb46hhvjmz9p8:audit-only:writeback:tp6:wg-close:integrator:6f41c157f5ace69e -->