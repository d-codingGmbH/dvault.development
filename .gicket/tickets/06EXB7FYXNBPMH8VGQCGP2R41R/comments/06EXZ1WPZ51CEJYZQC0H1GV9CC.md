...
- Unsupported inferred API claim: Restated, EF :: - Restated the ticket contract to remove unsupported inferred API/type claims, anchor `ModelBuilder.UseDataVault()` to current branch evidence, and let this ticket add the explicit EF translation entry point and any minimal missing public surface it needs; no child tickets, relations, attachments, or planning documents were created.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Restated, EF :: - Restated the ticket contract to remove unsupported inferred API/type claims, anchor `ModelBuilder.UseDataVault()` to current branch evidence, and let this ticket add the explicit EF translation entry point and any minimal missing public surface it needs; no child tickets, relations, attachments, or planning documents were created.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Restated, EF :: - Restated the ticket contract to remove unsupported inferred API/type claims, anchor `ModelBuilder.UseDataVault()` to current branch evidence, and let this ticket add the explicit EF translation entry point and any minimal missing public surface it needs; no child tickets, relations, attachments, or planning documents were created.
