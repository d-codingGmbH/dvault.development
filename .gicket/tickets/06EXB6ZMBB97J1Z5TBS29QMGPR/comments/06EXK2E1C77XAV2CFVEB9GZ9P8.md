...
- Unsupported inferred API claim in contract: Creating, EF, DbContext :: - Creating a UseDataVault API, EF provider integration, or DbContext-specific startup surface unless it already exists before development and can be used without product code expansion.
...
- Unsupported inferred API claim: Creating, EF, DbContext :: - Creating a UseDataVault API, EF provider integration, or DbContext-specific startup surface unless it already exists before development and can be used without product code expansion.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Creating, EF, DbContext :: - Creating a UseDataVault API, EF provider integration, or DbContext-specific startup surface unless it already exists before development and can be used without product code expansion.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Creating, EF, DbContext :: - Creating a UseDataVault API, EF provider integration, or DbContext-specific startup surface unless it already exists before development and can be used without product code expansion.
