...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F9G8EXXFJJ1SWWQXC2N9P2X8-story-multi-target-dvault-projects-for-net8-0-an"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f9g8exxfjj1swwqxc2n9p2x8:audit-only:writeback:tp6:wg-close:integrator:512dd8412f786e52 -->