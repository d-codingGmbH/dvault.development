...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F8KZP9XJ868GY6GT934QVFH4-story-define-support-bundle-freshness-and-finger"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f8kzp9xj868gy6gt934qvfh4:audit-only:writeback:tp6:wg-close:integrator:098f57ef00b5ae06 -->