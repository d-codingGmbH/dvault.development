...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSBWW414TE19KZT14CB7Y3R-task-prepare-v0-37-release-checklist-and-validat"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsbww414te19kzt14cb7y3r:audit-only:writeback:tp6:wg-close:integrator:bbbc2901f2cfa0e0 -->