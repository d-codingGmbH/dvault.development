...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FE4QPEZW97YR6YT7MQD1MXTG-task-add-db2-benchmark-promotion-guardrails"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fe4qpezw97yr6yt7mqd1mxtg:audit-only:writeback:tp6:wg-close:integrator:a4ed665321da7aa9 -->