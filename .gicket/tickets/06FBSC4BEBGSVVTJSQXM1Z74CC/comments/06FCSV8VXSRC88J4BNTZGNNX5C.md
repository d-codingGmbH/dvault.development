...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSC4BEBGSVVTJSQXM1Z74CC-task-collect-baseline-provider-optimization-evid"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsc4bebgsvvtjsqxm1z74cc:audit-only:writeback:tp6:wg-close:integrator:25136827da884b2b -->