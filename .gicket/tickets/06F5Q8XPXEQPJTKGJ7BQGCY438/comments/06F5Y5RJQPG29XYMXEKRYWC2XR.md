...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F5Q8XPXEQPJTKGJ7BQGCY438-story-explain-streaming-fallback-and-remediation"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f5q8xpxeqpjtkgj7bqgcy438:audit-only:writeback:tp6:wg-close:integrator:40acf4153927728a -->