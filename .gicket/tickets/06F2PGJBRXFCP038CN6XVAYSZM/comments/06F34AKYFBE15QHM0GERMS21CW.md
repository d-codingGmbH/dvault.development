...
- Unsupported inferred API claim in contract: Fixes :: - Fixes for non-mechanical selector shapes such as method calls, nested members, computed expressions, collection-valued members, selector variables, or inferred rewrites.
...
- Unsupported inferred API claim: Fixes :: - Fixes for non-mechanical selector shapes such as method calls, nested members, computed expressions, collection-valued members, selector variables, or inferred rewrites.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Fixes :: - Fixes for non-mechanical selector shapes such as method calls, nested members, computed expressions, collection-valued members, selector variables, or inferred rewrites.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Fixes :: - Fixes for non-mechanical selector shapes such as method calls, nested members, computed expressions, collection-valued members, selector variables, or inferred rewrites.
