...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FH8RC9F0QEWF356WF7YYNNGM-task-close-selected-provider-save-strategy-parit"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fh8rc9f0qewf356wf7yynngm:audit-only:writeback:tp6:wg-close:integrator:543c3d284c815df9 -->