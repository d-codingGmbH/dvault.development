...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F8KZHZ27SDTNCFNMFDQRVCKM-story-define-provider-read-strategy-evidence-con"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f8kzhz27sdtncfnmfdqrvckm:audit-only:writeback:tp6:wg-close:integrator:fb45c6b68034f8f7 -->