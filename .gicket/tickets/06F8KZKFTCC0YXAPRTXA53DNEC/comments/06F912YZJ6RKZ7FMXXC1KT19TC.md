...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F8KZKFTCC0YXAPRTXA53DNEC-task-update-v0-28-0-provider-read-optimization-d"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f8kzkftcc0yxaprtxa53dnec:audit-only:writeback:tp6:wg-close:integrator:86946c0bf6bc2942 -->