...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F5Q934MSKVCQAHPCWEM29CZW-story-add-hash-canonicalization-manifest-and-com"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f5q934mskvcqahpcwem29czw:audit-only:writeback:tp6:wg-close:integrator:6c22b7a428db5a21 -->