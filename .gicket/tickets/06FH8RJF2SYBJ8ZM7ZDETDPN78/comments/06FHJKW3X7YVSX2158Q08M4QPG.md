...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FH8RJF2SYBJ8ZM7ZDETDPN78-task-expose-provider-crypto-capability-facts-fro"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fh8rjf2sybj8zm7zdetdpn78:audit-only:writeback:tp6:wg-close:integrator:1bb06b3d500405be -->