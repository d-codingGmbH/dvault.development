...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F8KZNBGB8FPW6TK5A8SAJMVC-story-strengthen-provider-specific-migration-gua"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f8kznbgb8fpw6tk5a8sajmvc:audit-only:writeback:tp6:wg-close:integrator:b725264b20a836d3 -->