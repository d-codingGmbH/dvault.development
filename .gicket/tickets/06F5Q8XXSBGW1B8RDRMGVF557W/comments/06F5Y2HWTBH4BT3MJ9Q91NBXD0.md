...
- Unsupported inferred API claim in contract: No :: - No new public streaming/chunked save API, telemetry type, or retained-state contract design; those surfaces already exist in source, docs, and tests.
...
- Unsupported inferred API claim: No :: - No new public streaming/chunked save API, telemetry type, or retained-state contract design; those surfaces already exist in source, docs, and tests.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: No :: - No new public streaming/chunked save API, telemetry type, or retained-state contract design; those surfaces already exist in source, docs, and tests.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: No :: - No new public streaming/chunked save API, telemetry type, or retained-state contract design; those surfaces already exist in source, docs, and tests.
