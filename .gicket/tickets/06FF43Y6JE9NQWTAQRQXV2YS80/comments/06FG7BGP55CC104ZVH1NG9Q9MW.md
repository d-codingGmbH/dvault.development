...
- Unsupported inferred API claim in contract: Claiming :: - Claiming or relying on an already-existing public participant explain type that is not visible in current branch evidence.
...
- Unsupported inferred API claim: Claiming :: - Claiming or relying on an already-existing public participant explain type that is not visible in current branch evidence.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Claiming :: - Claiming or relying on an already-existing public participant explain type that is not visible in current branch evidence.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Claiming :: - Claiming or relying on an already-existing public participant explain type that is not visible in current branch evidence.
