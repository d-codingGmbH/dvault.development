...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSC08W24BJGFZ87RSFS21WC-task-report-selected-hash-storage-profile-in-dia"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsc08w24bjgfz87rsfs21wc:audit-only:writeback:tp6:wg-close:integrator:dd179bdb39ec49a3 -->