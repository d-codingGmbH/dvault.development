...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSBWPN112S4CGP0239K0ZT8-task-document-v0-37-dependency-and-analyzer-comp"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsbwpn112s4cgp0239k0zt8:audit-only:writeback:tp6:wg-close:integrator:0618b41b345548b1 -->