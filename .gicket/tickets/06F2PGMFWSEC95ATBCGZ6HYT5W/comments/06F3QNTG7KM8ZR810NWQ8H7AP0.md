...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F2PGMFWSEC95ATBCGZ6HYT5W-epic-provider-bulk-ingestion"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f2pgmfwsec95atbcgz6hyt5w:audit-only:writeback:tp6:wg-close:integrator:de77cb623cab12ff -->