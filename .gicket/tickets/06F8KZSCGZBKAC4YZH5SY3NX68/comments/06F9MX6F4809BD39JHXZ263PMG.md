...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F8KZSCGZBKAC4YZH5SY3NX68-task-add-opentelemetry-examples-for-dvault-activ"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f8kzscgzbkac4yzh5sy3nx68:audit-only:writeback:tp6:wg-close:integrator:f7b262ad9de7650c -->