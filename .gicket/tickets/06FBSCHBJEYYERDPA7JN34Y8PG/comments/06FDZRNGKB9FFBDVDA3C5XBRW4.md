...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSCHBJEYYERDPA7JN34Y8PG-task-document-provider-read-parity-outcomes-and"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbschbjeyyerdpa7jn34y8pg:audit-only:writeback:tp6:wg-close:integrator:b5d5b824f659bd4f -->