...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F5Q93AVHRYJBAPJCJEB4N7KG-task-document-database-side-hashing-boundary-and"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f5q93avhryjbapjcjeb4n7kg:audit-only:writeback:tp6:wg-close:integrator:8073a82cd672132d -->