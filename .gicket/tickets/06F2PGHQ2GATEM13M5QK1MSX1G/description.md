Detect common Code-First mistakes before runtime.

## Scope
- Refine and complete the work for "Expand Code-First analyzer diagnostics" within the boundaries of its parent story, epic, and release.
