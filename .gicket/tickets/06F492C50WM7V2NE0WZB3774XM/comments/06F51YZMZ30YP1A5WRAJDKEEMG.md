...
- Unsupported inferred API claim in contract: DataVaultDiagnosticsResult, ReadShape :: - The v0.17 baseline already ships DataVaultDiagnosticsResult.ReadShape plus public read-shape model types and support-bundle export; this ticket extends that existing public surface additively instead of introducing a second diagnostics member or service.
