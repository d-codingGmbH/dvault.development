...
- Unsupported inferred API claim in contract: Leaving :: - Leaving this ticket open as a development story risks duplicate work against API, docs, and tests that already exist in the repository.
...
- Unsupported inferred API claim: Leaving :: - Leaving this ticket open as a development story risks duplicate work against API, docs, and tests that already exist in the repository.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Leaving :: - Leaving this ticket open as a development story risks duplicate work against API, docs, and tests that already exist in the repository.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Leaving :: - Leaving this ticket open as a development story risks duplicate work against API, docs, and tests that already exist in the repository.
