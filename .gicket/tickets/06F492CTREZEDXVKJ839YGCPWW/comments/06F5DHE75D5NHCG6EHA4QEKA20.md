...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F492CTREZEDXVKJ839YGCPWW-story-add-provider-optimization-regression-basel"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f492ctrezedxvkj839ygcpww:audit-only:writeback:tp6:wg-close:integrator:e5902b9b7c3985b1 -->