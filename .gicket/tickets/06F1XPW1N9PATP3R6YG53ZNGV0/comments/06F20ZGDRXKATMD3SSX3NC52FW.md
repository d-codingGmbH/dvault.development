...
- Unsupported inferred API claim in contract: Refined :: - Refined the ticket around a focused model-first design-time workflow test and documentation update, using the existing public import, registration, and drift-report APIs with the default SQLite design-time provider baseline.
...
- Unsupported inferred API claim: Refined :: - Refined the ticket around a focused model-first design-time workflow test and documentation update, using the existing public import, registration, and drift-report APIs with the default SQLite design-time provider baseline.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Refined :: - Refined the ticket around a focused model-first design-time workflow test and documentation update, using the existing public import, registration, and drift-report APIs with the default SQLite design-time provider baseline.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Refined :: - Refined the ticket around a focused model-first design-time workflow test and documentation update, using the existing public import, registration, and drift-report APIs with the default SQLite design-time provider baseline.
