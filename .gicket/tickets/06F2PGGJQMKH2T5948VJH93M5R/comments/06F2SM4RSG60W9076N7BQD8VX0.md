...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F2PGGJQMKH2T5948VJH93M5R-task-implement-validate-export-drift-guardrail-c"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f2pggjqmkh2t5948vjh93m5r:audit-only:writeback:tp6:wg-close:integrator:dbc8445dea8ca335 -->