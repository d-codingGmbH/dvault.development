...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F2PGJSXP18VKKV52QZA4NP30-task-generate-metadata-and-row-factory-helpers"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f2pgjsxp18vkkv52qza4np30:audit-only:writeback:tp6:wg-close:integrator:b1342da3c9934659 -->