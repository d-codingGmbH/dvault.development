...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F9GF6CX7WE2JGBDW3QH1GX98-task-document-binary-hash-storage-adoption-guida"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f9gf6cx7we2jgbdw3qh1gx98:audit-only:writeback:tp6:wg-close:integrator:7c69d072f7b2dcaa -->