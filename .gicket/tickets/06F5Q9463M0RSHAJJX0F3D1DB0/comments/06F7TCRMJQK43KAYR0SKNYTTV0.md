...
- Unsupported inferred API claim in contract: Do :: - Do not assume or require any pre-existing public tracing API or public ActivitySource accessor.
...
- Unsupported inferred API claim: Do :: - Do not assume or require any pre-existing public tracing API or public ActivitySource accessor.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Do :: - Do not assume or require any pre-existing public tracing API or public ActivitySource accessor.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Do :: - Do not assume or require any pre-existing public tracing API or public ActivitySource accessor.
