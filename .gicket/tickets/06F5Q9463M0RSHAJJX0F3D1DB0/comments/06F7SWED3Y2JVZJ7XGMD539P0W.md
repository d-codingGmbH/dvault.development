...
- Unsupported inferred API claim in contract: Do :: - Do not assume or require any pre-existing public tracing API; any new holder/helper stays internal unless a public API change is intentionally snapshot-reviewed.
...
- Unsupported inferred API claim: Do :: - Do not assume or require any pre-existing public tracing API; any new holder/helper stays internal unless a public API change is intentionally snapshot-reviewed.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Do :: - Do not assume or require any pre-existing public tracing API; any new holder/helper stays internal unless a public API change is intentionally snapshot-reviewed.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Do :: - Do not assume or require any pre-existing public tracing API; any new holder/helper stays internal unless a public API change is intentionally snapshot-reviewed.
