...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F5Q94SQ086B2DZ1AKFDXGV94-task-update-v0-23-0-tracing-and-performance-guid"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f5q94sq086b2dz1akfdxgv94:audit-only:writeback:tp6:wg-close:integrator:b0a3ef44b041cb95 -->