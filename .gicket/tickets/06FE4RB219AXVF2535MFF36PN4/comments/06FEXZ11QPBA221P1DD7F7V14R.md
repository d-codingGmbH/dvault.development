...
- [dropped] `blocked-by-follow-up-comment` -> `06FE4RASEQZN7XEYH1XR4H06PR` via `blocks` path `06FE4RB219AXVF2535MFF36PN4 -> 06FE4RASEQZN7XEYH1XR4H06PR`
...
- [base-terminal-dropped] `relation-audit-follow-up` `06FE4RASEQZN7XEYH1XR4H06PR` owner `develop` base `develop` source-owner `ticket/06FE4RB219AXVF2535MFF36PN4-task-add-provider-mapping-tests-for-encrypted-pa`: Base branch 'develop' already contains ticket status 'done', so the relation follow-up is obsolete.
