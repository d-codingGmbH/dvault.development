...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FF43DC469VQ1N0NQ84KEV6SR-task-evaluate-oracle-pit-full-rebuild-push-down"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06ff43dc469vq1n0nq84kev6sr:audit-only:writeback:tp6:wg-close:integrator:dd1b47003995b96b -->