...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSCAD13RR10GHR82CPD864W-task-implement-accepted-mysql-bulk-improvement"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbscad13rr10ghr82cpd864w:audit-only:writeback:tp6:wg-close:integrator:201f798bbd6cce1a -->