...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSCA23YR3P9XRQA6MMYKV7C-task-implement-accepted-sql-server-bulk-improvem"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsca23yr3p9xrqa6mmykv7c:audit-only:writeback:tp6:wg-close:integrator:f31cafce051d6cb8 -->