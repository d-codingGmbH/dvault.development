...
- Unsupported inferred API claim in contract: Recursive :: - Recursive link and hierarchy bridge support depends on preserving participant order and role/endpoint binding through import diagnostics, even where existing public metadata APIs are ordinal-oriented.
...
- Unsupported inferred API claim: Recursive :: - Recursive link and hierarchy bridge support depends on preserving participant order and role/endpoint binding through import diagnostics, even where existing public metadata APIs are ordinal-oriented.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Recursive :: - Recursive link and hierarchy bridge support depends on preserving participant order and role/endpoint binding through import diagnostics, even where existing public metadata APIs are ordinal-oriented.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Recursive :: - Recursive link and hierarchy bridge support depends on preserving participant order and role/endpoint binding through import diagnostics, even where existing public metadata APIs are ordinal-oriented.
