...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F1XPZAJBSSNN6HY1CHAQPH74-story-add-opt-in-load-metadata-interceptors"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f1xpzajbssnn6hy1chaqph74:audit-only:writeback:tp6:wg-close:integrator:473a51e339ab4ca0 -->