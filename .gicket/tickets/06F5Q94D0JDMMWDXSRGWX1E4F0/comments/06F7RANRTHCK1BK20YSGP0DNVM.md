...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F5Q94D0JDMMWDXSRGWX1E4F0-story-add-activity-tracing-for-pit-and-bridge-ma"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f5q94d0jdmmwdxsrgwx1e4f0:audit-only:writeback:tp6:wg-close:integrator:9624cc35e20e2503 -->