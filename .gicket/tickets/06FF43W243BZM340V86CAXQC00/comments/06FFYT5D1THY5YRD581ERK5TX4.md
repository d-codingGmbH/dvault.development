...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FF43W243BZM340V86CAXQC00-task-prototype-analyzer-package-retargeting-if-a"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06ff43w243bzm340v86caxqc00:audit-only:writeback:tp6:wg-close:integrator:faf69b1ae36725ae -->