...
- Unsupported inferred API claim in contract: Reopen :: - Reopen PIT prototype tickets or bridge read optimization evidence that already exists for maintained bridge rows.
...
- Unsupported inferred API claim: Reopen :: - Reopen PIT prototype tickets or bridge read optimization evidence that already exists for maintained bridge rows.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Reopen :: - Reopen PIT prototype tickets or bridge read optimization evidence that already exists for maintained bridge rows.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Reopen :: - Reopen PIT prototype tickets or bridge read optimization evidence that already exists for maintained bridge rows.
