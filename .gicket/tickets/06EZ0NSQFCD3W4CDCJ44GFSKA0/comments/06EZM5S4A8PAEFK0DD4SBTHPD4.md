...
- Unsupported inferred API claim in contract: Refine :: - Refine or extend the existing API snapshot approval test and approved snapshot files so newly exported deferred-capability contracts are covered in the affected packable package.
...
- Unsupported inferred API claim: Refine :: - Refine or extend the existing API snapshot approval test and approved snapshot files so newly exported deferred-capability contracts are covered in the affected packable package.
...
- critic-item-3 [blocking-finding] Unsupported inferred API claim: Refine :: - Refine or extend the existing API snapshot approval test and approved snapshot files so newly exported deferred-capability contracts are covered in the affected packable package.

Missing examples / edge cases
- none

Risky assumptions
- Existing API/type assumption lacks source evidence: Refine :: - Refine or extend the existing API snapshot approval test and approved snapshot files so newly exported deferred-capability contracts are covered in the affected packable package.
