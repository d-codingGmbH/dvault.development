...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F8KZJNZ999C8NKY0S92VBDN0-story-add-mysql-and-oracle-pit-bridge-read-strat"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f8kzjnz999c8nky0s92vbdn0:audit-only:writeback:tp6:wg-close:integrator:1e7ef9c3b6847f20 -->