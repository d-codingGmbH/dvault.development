...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FF43HQ8E0435ZZSRZQQJW1HC-task-harden-pit-maintenance-unsupported-shape-fa"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06ff43hq8e0435zzsrzqqjw1hc:audit-only:writeback:tp6:wg-close:integrator:3f6c6c019eed365f -->