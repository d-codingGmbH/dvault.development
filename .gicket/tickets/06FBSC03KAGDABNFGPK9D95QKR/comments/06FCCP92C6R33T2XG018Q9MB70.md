...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSC03KAGDABNFGPK9D95QKR-task-preserve-existing-project-hex-compatibility"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsc03kagdabnfgpk9d95qkr:audit-only:writeback:tp6:wg-close:integrator:ef4514d3d7c74ebe -->