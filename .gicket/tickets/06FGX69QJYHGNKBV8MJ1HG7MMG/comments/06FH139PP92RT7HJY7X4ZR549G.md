...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FGX69QJYHGNKBV8MJ1HG7MMG-task-implement-hash-key-storage-migration-manife"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fgx69qjyhgnkbv8mj1hg7mmg:audit-only:writeback:tp6:wg-close:integrator:858631b089687aa9 -->