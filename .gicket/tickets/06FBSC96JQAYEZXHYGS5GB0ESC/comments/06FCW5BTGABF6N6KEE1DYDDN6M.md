...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06FBSC96JQAYEZXHYGS5GB0ESC-task-evaluate-sql-server-bulk-strategy-gaps"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06fbsc96jqayezxhygs5gb0esc:audit-only:writeback:tp6:wg-close:integrator:3c8787ad3059a2fa -->