...
```json
{
  ...
  "conditions": {
    "baseBranch": "develop",
    "mode": "squash",
    "sourceBranch": "ticket/06F2PGKJBG7NGNVBN0ZDSBE6B8-task-test-link-parent-satellite-metadata-project"
  }
}
```
...
<!-- gicket-semantic-idempotency-key: bot-writeback:06f2pgkjbg7ngnvbn0zdsbe6b8:audit-only:writeback:tp6:wg-close:integrator:852638418b7c12f6 -->